...
public class MapsActivity  extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        mOrigin = new LatLng(23.424076, 53.847818);;
        mDestination = new LatLng(24.1302, 55.8023);
        mMarkerPoints.clear();
        mMap.clear();
        ...
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(mOrigin.latitude, mOrigin.longitude), 12.0f));
    }
